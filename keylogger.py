...
mail_content = "Mail with the following attachment."  # Text for sending the attachment
sender_address = 'fakeid@gmail.com'  # Enter your fake id here.
sender_pass = 'passwordgoeshere'  # Original pass of fake id
receiver_address = 'receiverid@gmail.com'  # Enter the receiver id
attach_file_name = ''
attach_file = ''
message = ''
session = ''
